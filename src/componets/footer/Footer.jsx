...
const Footer = () => {
    return (    <section className="footer" id="footer">
         <MDBFooter backgroundColor='bg-light text-center text-lg-left'>
        ...
        <MDBRow>
          <MDBCol lg='6' md='12' className='mb-4 mb-md-0'>
            ...
            <p>
              ...
              Etiam turpis urna, rhoncus et mattis ut, dapibus eu turpis.
            </p>
          </MDBCol>
      ...
      <div className='text-center p-3' style={{ backgroundColor: 'rgba(0, 0, 0, 0.2)' }}>
        © {new Date().getFullYear()} YourWebsite.com
      </div>
    </MDBFooter>
